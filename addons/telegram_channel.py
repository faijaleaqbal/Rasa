...
class SmartTelegramInput(TelegramInput):
    ...
    def _register_telegram_commands(self) -> None:
        ...
        commands = [
            ...
            {"command": "hash", "description": "🔑 MD5/SHA-256/Base64 hash"},
            ...
            {"command": "sip", "description": "📈 Mutual Fund SIP wealth calculator"},
            {"command": "emi", "description": "🏦 Loan EMI & interest calculator"},
